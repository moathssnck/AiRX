  ...
  return (
    <section className="min-h-screen pt-32 pb-20 px-4 sm:px-6 lg:px-8 flex items-center justify-center relative overflow-hidden">
      ...
      <div className="max-w-5xl mx-auto text-center">
        ...
        >
          <button className="px-8 py-4 bg-gradient-to-r from-emerald-500 to-accent text-emerald-500-foreground rounded-full font-semibold hover:shadow-xl hover:shadow-emerald-500/40 transition-all duration-300 group">
            {t.start_project}
          </button>
